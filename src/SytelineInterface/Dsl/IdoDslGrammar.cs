...
namespace SytelineInterface.Dsl
{
        ...
        where PARAMBUILDER : IdoQueryBuilder<PARAMBUILDER, FILTERBUILDER>
    {
        ...
        public PARAMBUILDER WhereExp<TCriteria>(Expression<Func<TCriteria, bool>> exp) where TCriteria : IdoCriteria
        { 
        ...
        where FILTERBUILDER : FilterExpressionBuilder<PARAMBUILDER>, new()
    {
        ...
        public PARAMBUILDER Eq(String rhs)
        {
            _operand = "=";
            _rhs = SqlLiteral.Format(rhs);
            _builder.AddFilterExpression(this);
            return _builder;
        }

        public PARAMBUILDER GreaterThan(DateTime rhs)
        {
            _operand = ">";
            _rhs = SqlLiteral.Format(rhs);
            _builder.AddFilterExpression(this);
        ...
        public PARAMBUILDER In(IEnumerable<string> rhs)
        {
            _operand = " IN ";
            _rhs = "(" + string.Join(",", rhs.Select<string, string>(SqlLiteral.Format).ToArray()) + ")";
            _builder.AddFilterExpression(this);
            return _builder;
        }

        public PARAMBUILDER In(IEnumerable<DateTime> rhs)
        {
            _operand = " IN ";
            _rhs = "(" + string.Join(",", rhs.Select<DateTime, string>(dt => SqlLiteral.Format(dt.ToString())).ToArray()) + ")";
            _builder.AddFilterExpression(this);
            return _builder;
        }

        public PARAMBUILDER In(IEnumerable<int> rhs)
        {
            _operand = " IN ";
            _rhs = "(" + string.Join(",", rhs.Select(dt => SqlLiteral.Format(dt.ToString())).ToArray()) + ")";
            _builder.AddFilterExpression(this);
            return _builder;
        }

        public PARAMBUILDER In(IEnumerable<decimal> rhs)
        {
            _operand = " IN ";
            _rhs = "(" + string.Join(",", rhs.Select(dt => SqlLiteral.Format(dt.ToString())).ToArray()) + ")";
            _builder.AddFilterExpression(this);
        ...
        public PARAMBUILDER Contains(string rhs)
        {
            _operand = " LIKE ";
            _rhs = SqlLiteral.Format(string.Format("%{0}%", rhs));
            _builder.AddFilterExpression(this);
            return _builder;
        }
        ...
        public PARAMBUILDER StartsWith(string rhs)
        { 
            _operand = " LIKE ";
            _rhs = SqlLiteral.Format(string.Format("{0}%", rhs));
            _builder.AddFilterExpression(this);
        ...
        public PARAMBUILDER EndsWith(string rhs)
        {
            _operand = " LIKE ";
            _rhs = SqlLiteral.Format(string.Format("%{0}", rhs));
            _builder.AddFilterExpression(this);
        ...
        public PARAMBUILDER GreaterThan(string rhs)
        {
            _operand = ">";
            _rhs = SqlLiteral.Format(rhs);
            _builder.AddFilterExpression(this);
        ...
        public PARAMBUILDER GreaterThan(int rhs)
        {  
            _operand = ">"; 
            _rhs = SqlLiteral.Format(rhs);
            _builder.AddFilterExpression(this);
        ...
        public PARAMBUILDER IsNull()
        {
            _operand = " IS ";
            _rhs = SqlLiteral.NULL;
            _builder.AddFilterExpression(this);
            return _builder;
        }

        public PARAMBUILDER IsNotNull()
        {
            _unary = " NOT ";
            _operand = " IS ";
            _rhs = SqlLiteral.NULL; 
        ...
        public PARAMBUILDER NotEq(string rhs)
        {
            _operand = "<>";
            _rhs = SqlLiteral.Format(rhs);
            _builder.AddFilterExpression(this);
        ...
        public PARAMBUILDER LessThan(DateTime rhs)
        {
            _operand = "<";
            _rhs = SqlLiteral.Format(rhs);
            _builder.AddFilterExpression(this);
        ...
        public PARAMBUILDER Eq(bool rhs)
        {
            _operand = "=";
            int val = rhs ? 1:0; 
            _rhs = SqlLiteral.Format(val);
            _builder.AddFilterExpression(this);
            return _builder;
        }

        public PARAMBUILDER Eq(DateTime rhs)
        {
            _operand = "="; 
            _rhs = SqlLiteral.Format(rhs);
            _builder.AddFilterExpression(this);
